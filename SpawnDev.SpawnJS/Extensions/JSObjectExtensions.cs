...
namespace SpawnDev.SpawnJS.Extensions
{
    ...
    public static partial class JSObjectExtensions
    {
        ...
        /// Get the property value as T using JSON seriliazation
        /// </summary>
        public static T GetPropertyAsJson<T>(this JSObject _this, object identifier)
        {
            using var jsObject = _this.GetPropertyAsJSObject(identifier);
            var json = jsObject == null ? null : JSON.Stringify(jsObject);
            return json == null ? default! : JsonSerializer.Deserialize<T>(json)!;
        ...
        /// Get the property value as T using JSON seriliazation
        /// </summary>
        public static T GetPropertyAsJson<T>(this JSObject _this, object identifier, JsonSerializerOptions jsonSerializerOptions)
        {
            using var jsObject = _this.GetPropertyAsJSObject(identifier);
            var json = jsObject == null ? null : JSON.Stringify(jsObject);
            return json == null ? default! : JsonSerializer.Deserialize<T>(json, jsonSerializerOptions)!;
        ...
        /// Get the property value as object
        /// </summary>
        public static object? GetPropertyAsObject(this JSObject _this, object identifier) => Reflect.GetObject(_this, identifier);
        /// <summary>
        /// Get the property value as nullable int
        /// </summary>
        public static int? GetPropertyAsInt32Nullable(this JSObject _this, object identifier) => Reflect.GetInt32Nullable(_this, identifier);
        /// <summary>
        /// Get the property value as nullable double
        /// </summary>
        public static double? GetPropertyAsDoubleNullable(this JSObject _this, object identifier) => Reflect.GetDoubleNullable(_this, identifier);
        /// <summary>
        /// Get the property value as nullable bool
        /// </summary>
        /// <param name="_this"></param>
        /// <param name="identifier"></param>
        /// <returns></returns>
        public static bool? GetPropertyAsBooleanNullable(this JSObject _this, object identifier) => Reflect.GetBooleanNullable(_this, identifier);
        /// <summary>
        ...
        /// <param name="identifier"></param>
        /// <returns></returns>
        public static bool GetPropertyAsBoolean(this JSObject _this, object identifier) => Reflect.GetBoolean(_this, identifier);
        /// <summary>
        ...
        /// <param name="identifier"></param>
        /// <returns></returns>
        public static int GetPropertyAsInt32(this JSObject _this, object identifier) => Reflect.GetInt32(_this, identifier);
        /// <summary>
        ...
        /// <param name="identifier"></param>
        /// <returns></returns>
        public static double GetPropertyAsDouble(this JSObject _this, object identifier) => Reflect.GetDouble(_this, identifier);
        /// <summary>
        ...
        /// <param name="identifier"></param>
        /// <returns></returns>
        public static string? GetPropertyAsString(this JSObject _this, object identifier) => Reflect.GetString(_this, identifier);
        /// <summary>
        ...
        /// <param name="identifier"></param>
        /// <returns></returns>
        public static JSObject? GetPropertyAsJSObject(this JSObject _this, object identifier) => Reflect.GetJSObject(_this, identifier);
        /// <summary>
        ...
        /// <param name="identifier"></param>
        /// <returns></returns>
        public static byte[]? GetPropertyAsByteArray(this JSObject _this, object identifier) => Reflect.GetByteArray(_this, identifier);
        /// <summary>
        /// Delete the property
        /// </summary>
        /// <param name="_this"></param>
        /// <param name="identifier"></param>
        /// <returns></returns>
        public static bool DeleteProperty(this JSObject _this, object identifier) => Reflect.DeletePropertyVoid(_this, identifier);
        /// <summary>
        /// Set the property to the specified value
        /// </summary>
        /// <param name="_this"></param>
        /// <param name="identifier"></param>
        /// <param name="value"></param>
        public static void SetProperty(this JSObject _this, object identifier, bool value) => Reflect.Set(_this, identifier, value);
        /// <summary>
        /// Set the property to the specified value
        /// </summary>
        /// <param name="_this"></param>
        /// <param name="identifier"></param>
        /// <param name="value"></param>
        public static void SetProperty(this JSObject _this, object identifier, int value) => Reflect.Set(_this, identifier, value);
        /// <summary>
        /// Set the property to the specified value
        /// </summary>
        /// <param name="_this"></param>
        /// <param name="identifier"></param>
        /// <param name="value"></param>
        public static void SetProperty(this JSObject _this, object identifier, double value) => Reflect.Set(_this, identifier, value);
        /// <summary>
        /// Set the property to the specified value
        /// </summary>
        /// <param name="_this"></param>
        /// <param name="identifier"></param>
        /// <param name="value"></param>
        public static void SetProperty(this JSObject _this, object identifier, string? value) => Reflect.Set(_this, identifier, value);
        /// <summary>
        /// Set the property to the specified value
        /// </summary>
        /// <param name="_this"></param>
        /// <param name="identifier"></param>
        /// <param name="value"></param>
        public static void SetProperty(this JSObject _this, object identifier, JSObject? value) => Reflect.Set(_this, identifier, value);
        /// <summary>
        /// Set the property to the specified value
        /// </summary>
        /// <param name="_this"></param>
        /// <param name="identifier"></param>
        /// <param name="value"></param>
        public static void SetProperty(this JSObject _this, object identifier, byte[]? value) => Reflect.Set(_this, identifier, value);
        /// <summary>
        /// Get the property value as T using JSON seriliazation
        /// </summary>
        /// <typeparam name="T"></typeparam>
        ...
        /// <param name="identifier"></param>
        /// <returns></returns>
        public static bool DeleteProperty(this JSObject _this, int identifier) => Reflect.DeletePropertyVoid(_this, identifier);
        /// <summary>
        /// Set the property to the specified value
        /// </summary>
        /// <param name="_this"></param>
