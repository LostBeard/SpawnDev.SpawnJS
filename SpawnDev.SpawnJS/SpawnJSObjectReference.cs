...
namespace SpawnDev.SpawnJS
{
    ...
    public class SpawnJSObjectReference : IDisposable, ISpawnJSObjectReference
    {
        SpawnJSRuntime _runtime => SpawnJSRuntime.Instance ?? throw new InvalidOperationException("SpawnJSRuntime has not been created.");
        /// <summary>
        /// Returns true if JSObject is null or disposed
        /// </summary>
        public bool IsDisposed => JSObject?.IsDisposed != false;
        /// <summary>
        ...
        /// <returns></returns>
        public T As<T>() => _runtime.NetRun<T>("returnMe", new object[] { JSObject });
        /// <summary>
        ...
        /// <returns></returns>
        public T Get<T>(string identifier) => _runtime.NetRun<T>("getProperty", new object[] { JSObject, identifier });
        /// <summary>
        /// Get object property as T
        /// </summary>
        /// <typeparam name="T"></typeparam>
        /// <param name="identifier"></param>
        /// <returns></returns>
        public Task<T> GetAsync<T>(string identifier) => _runtime.NetRunAsync<T>("getProperty", new object[] { JSObject, identifier });
        /// <summary>
        ...
        public bool Has(string identifier, bool useIn = true)
            => useIn ? _runtime.NetRun<bool>("_in", new object[] { identifier, JSObject }) : _runtime.NetRun<bool>("hasOwnPropertySafe", new object[] { JSObject, identifier });
        ...
        public void Set(string identifier, object? value) => _runtime.NetRunVoid("setProperty", new object[] { JSObject, identifier, value! });

        /// <summary>
        /// Delete an object property
        /// </summary>
        /// <param name="identifier"></param>
        public void Delete(string identifier) => _runtime.NetRunVoid("deleteProperty", new object[] { JSObject, identifier });
        ...
        /// Call the property constructor
        /// </summary>
        public SpawnJSObjectReference NewApply(string identifier, object?[] args) => _runtime.NetRun<SpawnJSObjectReference>("invokePropertyConstructor", new object[] { JSObject, identifier, args });
        #endregion
        ...
        /// Call the property constructor
        /// </summary>
        public T NewApply<T>(string identifier, object?[] args) => _runtime.NetRun<T>("invokePropertyConstructor", new object[] { JSObject, identifier, args });
        #endregion
        ...
        /// <returns></returns>
        public T CallApply<T>(string identifier, object?[] args) => _runtime.NetRun<T>("invokeProperty", new object[] { JSObject, identifier, args });
        #endregion
        ...
        /// <param name="identifier"></param>
        /// <param name="args"></param>
        public void CallVoidApply(string identifier, object?[] args) => _runtime.NetRunVoid("invokeProperty", new object[] { JSObject, identifier, args });
        #endregion
        ...
        /// <param name="identifier"></param>
        /// <param name="args"></param>
        public Task CallVoidApplyAsync(string identifier, object?[] args) => _runtime.NetRunVoidAsync("invokeProperty", new object[] { JSObject, identifier, args });
        #endregion
        ...
        /// <param name="identifier"></param>
        /// <param name="args"></param>
        public Task<T> CallApplyAsync<T>(string identifier, object?[] args) => _runtime.NetRunAsync<T>("invokeProperty", new object[] { JSObject, identifier, args });
        #endregion
