...
namespace SpawnDev.SpawnJS.JSObjects
{
    ...
    public class CredentialsContainer : SpawnJSObject
    {
        ...
        /// <returns></returns>
        public Task<T> Create<[DynamicallyAccessedMembers(DynamicallyAccessedMemberTypes.PublicConstructors)] T>(CredentialCreateOptions options) where T : Credential => JSRef!.CallAsync<CredentialCreateOptions, T>("create", options);
        /// <summary>
        /// Returns a Promise that resolves with a new Credential instance based on the provided options, or null if no Credential object can be created. In exceptional circumstances, the Promise may reject.
        /// </summary>
        /// <param name="options"></param>
        /// <returns></returns>
        public Task<PublicKeyCredential<AuthenticatorAttestationResponse>> Create(CredentialCreatePublicKeyOptions options) => JSRef!.CallAsync<CredentialCreatePublicKeyOptions, PublicKeyCredential<AuthenticatorAttestationResponse>>("create", options);
        /// <summary>
        ...
        /// <param name="options"></param>
        /// <returns></returns>
        public Task<T> Get<[DynamicallyAccessedMembers(DynamicallyAccessedMemberTypes.PublicConstructors)] T>(CredentialGetOptions options) where T : Credential => JSRef!.CallAsync<CredentialGetOptions, T>("get", options);
        /// <summary>
        /// Returns a Promise that resolves with the PublicKeyCredential or null
        /// </summary>
        /// <param name="options"></param>
        /// <returns></returns>
        public Task<PublicKeyCredential<AuthenticatorAssertionResponse>?> Get(CredentialGetPublicKeyOptions options) => JSRef!.CallAsync<CredentialGetPublicKeyOptions, PublicKeyCredential<AuthenticatorAssertionResponse>?>("get", options);
        /// <summary>
