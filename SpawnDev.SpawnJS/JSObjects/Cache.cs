...
namespace SpawnDev.SpawnJS.JSObjects
{
    ...
    public class Cache : SpawnJSObject
    {
        ...
        /// <param name="options"></param>
        /// <returns></returns>
        public Task<Response[]> MatchAll(string request, CacheMatchOptions options) => JSRef!.CallAsync<string, CacheMatchOptions, Response[]>("matchAll", request, options);
        ...
        /// <param name="options"></param>
        /// <returns></returns>
        public Task<bool> Delete(string request, CacheMatchOptions options) => JSRef!.CallAsync<string, CacheMatchOptions, bool>("delete", request, options);
        /// <summary>
        /// Finds the Cache entry whose key is the request, returning a Promise that resolves to true if a matching Cache entry is found and deleted. If no Cache entry is found, the promise resolves to false.
        /// </summary>
        /// <param name="request"></param>
        /// <returns></returns>
        public Task<bool> Delete(Request request) => JSRef!.CallAsync<Request, bool>("delete", request);
        /// <summary>
        /// Finds the Cache entry whose key is the request, returning a Promise that resolves to true if a matching Cache entry is found and deleted. If no Cache entry is found, the promise resolves to false.
        /// </summary>
        /// <param name="request"></param>
        /// <param name="options"></param>
        /// <returns></returns>
        public Task<bool> Delete(Request request, CacheMatchOptions options) => JSRef!.CallAsync<Request, CacheMatchOptions, bool>("delete", request, options);
        /// <summary>
        ...
        /// <param name="options"></param>
        /// <returns></returns>
        public Task<Request[]> Keys(string request, CacheMatchOptions options) => JSRef!.CallAsync<string, CacheMatchOptions, Request[]>("keys", request, options);
        /// <summary>
        /// Returns a Promise that resolves to an array of Cache keys which are Request objects
        /// </summary>
        /// <param name="request"></param>
        /// <returns></returns>
        public Task<Request[]> Keys(Request request) => JSRef!.CallAsync<Request, Request[]>("keys", request);
        /// <summary>
        /// Returns a Promise that resolves to an array of Cache keys which are Request objects
        /// </summary>
        /// <param name="request"></param>
        /// <param name="options"></param>
        /// <returns></returns>
        public Task<Request[]> Keys(Request request, CacheMatchOptions options) => JSRef!.CallAsync<Request, CacheMatchOptions, Request[]>("keys", request, options);
    }
}
