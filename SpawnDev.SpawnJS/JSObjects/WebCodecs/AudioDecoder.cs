...
namespace SpawnDev.SpawnJS.JSObjects
{
    ...
    public class AudioDecoder : EventTarget
    {
        ...
        /// </summary>
        public static Task<AudioDecoderSupport> IsConfigSupported(AudioDecoderConfig config) => JS.CallAsync<AudioDecoderConfig, AudioDecoderSupport>($"{nameof(AudioDecoder)}.isConfigSupported", config);
    }
}
