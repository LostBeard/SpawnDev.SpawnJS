...
namespace SpawnDev.SpawnJS.JSObjects
{
    ...
    public class TextDetector : SpawnJSObject
    {
        ...
        public Task<List<DetectedText>> Detect(Union<Blob, Element, ImageData, ImageBitmap, OffscreenCanvas> imageBitmapSource) => JSRef!.CallAsync<global::SpawnDev.SpawnJS.Union<Blob, Element, ImageData, ImageBitmap, OffscreenCanvas>, List<DetectedText>>("detect", imageBitmapSource);
    }
}
