...
namespace SpawnDev.SpawnJS.JSObjects
{
    ...
    public class FaceDetector : SpawnJSObject
    {
        ...
        public Task<List<DetectedFace>> Detect(Union<Blob, Element, ImageData, ImageBitmap, OffscreenCanvas> imageBitmapSource) => JSRef!.CallAsync<global::SpawnDev.SpawnJS.Union<Blob, Element, ImageData, ImageBitmap, OffscreenCanvas>, List<DetectedFace>>("detect", imageBitmapSource);
    }
}
