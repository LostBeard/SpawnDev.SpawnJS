...
namespace SpawnDev.SpawnJS.JSObjects
{
    ...
    public class MediaCapabilities : SpawnJSObject
    {
        ...
        /// <returns></returns>
        public Task<MediaCapabilitiesInfo> DecodingInfo(DecodingConfiguration configuration) => JSRef!.CallAsync<DecodingConfiguration, MediaCapabilitiesInfo>("decodingInfo", configuration);
        /// <summary>
        ...
        /// <param name="configuration"></param>
        /// <returns></returns>
        public Task<MediaCapabilitiesInfo> EncodingInfo(EncodingConfiguration configuration) => JSRef!.CallAsync<EncodingConfiguration, MediaCapabilitiesInfo>("encodingInfo", configuration);
        #endregion
    }
}
