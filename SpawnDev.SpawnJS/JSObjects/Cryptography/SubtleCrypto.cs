...
namespace SpawnDev.SpawnJS.JSObjects
{
    ...
    public class SubtleCrypto : SpawnJSObject
    {
        ...
        public Task<ArrayBuffer> Digest(string algorithm, BufferSource data) => JSRef!.CallAsync<string, global::SpawnDev.SpawnJS.Union<ArrayBuffer, TypedArray, DataView, byte[]>, ArrayBuffer>("digest", algorithm, data);
        /// <summary>
        ...
        public Task<ArrayBuffer> Decrypt(EncryptParams algorithm, CryptoKey key, BufferSource data) => JSRef!.CallAsync<EncryptParams, CryptoKey, global::SpawnDev.SpawnJS.Union<ArrayBuffer, TypedArray, DataView, byte[]>, ArrayBuffer>("decrypt", algorithm, key, data);
        /// <summary>
        ...
        public Task<ArrayBuffer> Encrypt(EncryptParams algorithm, CryptoKey key, BufferSource data) => JSRef!.CallAsync<EncryptParams, CryptoKey, global::SpawnDev.SpawnJS.Union<ArrayBuffer, TypedArray, DataView, byte[]>, ArrayBuffer>("encrypt", algorithm, key, data);
        /// <summary>
        ...
        /// </returns>
        public Task<T> ExportKey<[DynamicallyAccessedMembers(DynamicallyAccessedMemberTypes.PublicConstructors)] T>(string format, CryptoKey key) => JSRef!.CallAsync<string, CryptoKey, T>("exportKey", format, key);
        /// <summary>
        ...
        public Task<ArrayBuffer> ExportKeySpki(CryptoKey key) => JSRef!.CallAsync<string, CryptoKey, ArrayBuffer>("exportKey", "spki", key);
        /// <summary>
        /// Export key in PKCS #8 format. Can be used to export RSA or Elliptic Curve private keys.
        /// </summary>
        /// <param name="key">the CryptoKey to export</param>
        /// <returns>A Promise that fulfills with an ArrayBuffer containing the key</returns>
        public Task<ArrayBuffer> ExportKeyPkcs8(CryptoKey key) => JSRef!.CallAsync<string, CryptoKey, ArrayBuffer>("exportKey", "pkcs8", key);
        /// <summary>
        ...
        /// <param name="key">the CryptoKey to export</param>
        /// <returns>A Promise that fulfills with an ArrayBuffer containing the key</returns>
        public Task<ArrayBuffer> ExportKeyRaw(CryptoKey key) => JSRef!.CallAsync<string, CryptoKey, ArrayBuffer>("exportKey", "raw", key);
        /// <summary>
        ...
        public Task<SpawnJSObject> ExportKeyJwk(CryptoKey key) => JSRef!.CallAsync<string, CryptoKey, SpawnJSObject>("exportKey", "jwk", key);
        /// <summary>
        /// You can use JSON Web Key format to export RSA or Elliptic Curve public or private keys, as well as AES and HMAC secret keys.<br/>
        /// JSON Web Key format is defined in RFC 7517. It describes a way to represent public, private, and secret keys as JSON objects.
        /// </summary>
        /// <param name="key">the CryptoKey to export</param>
        /// <returns>A Promise that fulfills with a JSON object containing the key</returns>
        public Task<TJWK> ExportKey<[DynamicallyAccessedMembers(DynamicallyAccessedMemberTypes.PublicConstructors)] TJWK>(CryptoKey key) where TJWK : JWK => JSRef!.CallAsync<string, CryptoKey, TJWK>("exportKey", "jwk", key);
        /// <summary>
        ...
        public Task<CryptoKey> ImportKey(string format, Union<ArrayBuffer, TypedArray, DataView, byte[], JWK> keyData, Union<CryptoImportParams, string> algorithm, bool extractable, IEnumerable<string> keyUsages) => JSRef!.CallAsync<string, global::SpawnDev.SpawnJS.Union<ArrayBuffer, TypedArray, DataView, byte[], JWK>, global::SpawnDev.SpawnJS.Union<CryptoImportParams, string>, bool, global::System.Collections.Generic.IEnumerable<string>, CryptoKey>("importKey", format, keyData, algorithm, extractable, keyUsages);
        /// <summary>
        /// The importKey() method of the SubtleCrypto interface imports a key: that is, it takes as input a key in an external, portable format and gives you a CryptoKey object that you can use in the Web Crypto API.
        /// </summary>
        ...
        /// <param name="keyUsages">An Array indicating what can be done with the key. Possible array values are: encrypt, decrypt, sign, verify, deriveKey, deriveBits, wrapKey, or unwrapKey.</param>
        /// <returns>A Promise that fulfills with the imported key as a CryptoKey object.</returns>
        public Task<CryptoKey> ImportKey(JWK keyData, Union<CryptoImportParams, string> algorithm, bool extractable, IEnumerable<string> keyUsages) => JSRef!.CallAsync<string, JWK, global::SpawnDev.SpawnJS.Union<CryptoImportParams, string>, bool, global::System.Collections.Generic.IEnumerable<string>, CryptoKey>("importKey", "jwk", keyData, algorithm, extractable, keyUsages);
        /// <summary>
        /// The importKey() method of the SubtleCrypto interface imports a key: that is, it takes as input a key in an external, portable format and gives you a CryptoKey object that you can use in the Web Crypto API.
        /// </summary>
        /// <typeparam name="T"></typeparam>
        ...
        public Task<ArrayBuffer> Sign(Union<CryptoSignParams, string> algorithm, CryptoKey key, BufferSource data) => JSRef!.CallAsync<global::SpawnDev.SpawnJS.Union<CryptoSignParams, string>, CryptoKey, global::SpawnDev.SpawnJS.Union<ArrayBuffer, TypedArray, DataView, byte[]>, ArrayBuffer>("sign", algorithm, key, data);
        /// <summary>
        ...
        public Task<ArrayBuffer> WrapKey(string format, CryptoKey key, CryptoKey wrappingKey, EncryptParams wrapAlgo) => JSRef!.CallAsync<string, CryptoKey, CryptoKey, EncryptParams, ArrayBuffer>("wrapKey", format, key, wrappingKey, wrapAlgo);
        /// <summary>
        ...
        public Task<ArrayBuffer> DeriveBits(KeyDeriveParams algorithm, CryptoKey baseKey, int length) => JSRef!.CallAsync<KeyDeriveParams, CryptoKey, int, ArrayBuffer>("deriveBits", algorithm, baseKey, length);
        #endregion
    }
}
