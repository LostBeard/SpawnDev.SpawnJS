...
namespace SpawnDev.SpawnJS.JSObjects
{
    ...
    public class GPUCommandEncoder : GPUObjectBase
    {
        ...
        public GPURenderPassEncoder BeginRenderPass(GPURenderPassDescriptor descriptor) => JSRef!.Call<GPURenderPassDescriptor, GPURenderPassEncoder>("beginRenderPass", descriptor);
        ...
        /// <returns>A <see cref="GPUCommandBuffer"/> containing the recorded commands. The command buffer can be submitted to a
        /// GPU queue for execution.</returns>
        public GPUCommandBuffer Finish(GPUCommandBufferDescriptor descriptor) => JSRef!.Call<GPUCommandBufferDescriptor, GPUCommandBuffer>("finish", descriptor);
        ...
        public GPUComputePassEncoder BeginComputePass(GPUComputePassDescriptor? descriptor = null) => descriptor == null ? JSRef!.Call<GPUComputePassEncoder>("beginComputePass") : JSRef!.Call<GPUComputePassDescriptor, GPUComputePassEncoder>("beginComputePass", descriptor);
    }
}
