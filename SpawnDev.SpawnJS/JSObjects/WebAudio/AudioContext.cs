...
namespace SpawnDev.SpawnJS.JSObjects
{
    ...
    public class AudioContext : BaseAudioContext
    {
        ...
        /// <returns></returns>
        public MediaStreamAudioSourceNode CreateMediaStreamSource(MediaStream mediaStream) => JSRef!.Call<MediaStream, MediaStreamAudioSourceNode>("createMediaStreamSource", mediaStream);
        /// <summary>
        ...
        /// <returns></returns>
        public MediaElementAudioSourceNode CreateMediaElementSource(HTMLMediaElement mediaElement) => JSRef!.Call<HTMLMediaElement, MediaElementAudioSourceNode>("createMediaElementSource", mediaElement);
        /// <summary>
        ...
        /// <returns></returns>
        public MediaStreamTrackAudioSourceNode CreateMediaStreamTrackSource(MediaStreamTrack track) => JSRef!.Call<MediaStreamTrack, MediaStreamTrackAudioSourceNode>("createMediaStreamTrackSource", track);
        /// <summary>
