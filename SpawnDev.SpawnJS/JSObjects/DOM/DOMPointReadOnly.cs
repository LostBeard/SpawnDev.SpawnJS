...
namespace SpawnDev.SpawnJS.JSObjects
{
    ...
    public class DOMPointReadOnly : SpawnJSObject
    {
        ...
        public static DOMPointReadOnly FromPoint(DOMPointInit point) => JS.New<DOMPointInit, DOMPointReadOnly>(nameof(DOMPointReadOnly), point);
        ...
        /// <param name="point"></param>
        /// <returns></returns>
        public static DOMPointReadOnly FromPoint(DOMPoint point) => JS.Call<DOMPoint, DOMPointReadOnly>($"{nameof(DOMPointReadOnly)}.fromPoint", point);
        ...
        /// <param name="point"></param>
        /// <returns></returns>
        public static DOMPointReadOnly FromPoint(DOMPointReadOnly point) => JS.Call<DOMPointReadOnly, DOMPointReadOnly>($"{nameof(DOMPointReadOnly)}.fromPoint", point);
        ...
        /// <returns>A new DOMPointReadOnly object.</returns>
        public DOMPointReadOnly MatrixTransform(DOMMatrixInit matrix) => JSRef!.Call<DOMMatrixInit, DOMPointReadOnly>("matrixTransform", matrix);
        ...
        /// <param name="matrix">A DOMMatrixInit dictionary or another DOMMatrixReadOnly object to transform the point with.</param>
        /// <returns>A new DOMPointReadOnly object.</returns>
        public DOMPointReadOnly MatrixTransform(DOMMatrix matrix) => JSRef!.Call<DOMMatrix, DOMPointReadOnly>("matrixTransform", matrix);
        ...
        /// <param name="matrix">A DOMMatrixInit dictionary or another DOMMatrixReadOnly object to transform the point with.</param>
        /// <returns>A new DOMPointReadOnly object.</returns>
        public DOMPointReadOnly MatrixTransform(DOMMatrixReadOnly matrix) => JSRef!.Call<DOMMatrixReadOnly, DOMPointReadOnly>("matrixTransform", matrix);
