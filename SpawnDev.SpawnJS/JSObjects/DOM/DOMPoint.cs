...
namespace SpawnDev.SpawnJS.JSObjects
{
    ...
    public class DOMPoint : DOMPointReadOnly
    {
        ...
        public static new DOMPoint FromPoint(DOMPointInit point) => JS.New<DOMPointInit, DOMPoint>("DOMPoint", point);
        ...
        /// <returns>A new DOMPoint object.</returns>
        public new DOMPoint MatrixTransform(DOMMatrixInit matrix) => JSRef!.Call<DOMMatrixInit, DOMPoint>("matrixTransform", matrix);
    }
