...
namespace SpawnDev.SpawnJS.JSObjects
{
    ...
    public class FileSystemDirectoryHandle : FileSystemHandle
    {
        ...
        /// <returns></returns>
        public Task<FileSystemDirectoryHandle> GetDirectoryHandle(string name, bool create = false) => JSRef!.CallAsync<string, GetHandleOptions, FileSystemDirectoryHandle>("getDirectoryHandle", name, new GetHandleOptions { Create = create });
        /// <summary>
        ...
        /// <param name="create"></param>
        /// <returns></returns>
        public Task<FileSystemFileHandle> GetFileHandle(string name, bool create = false) => JSRef!.CallAsync<string, GetHandleOptions, FileSystemFileHandle>("getFileHandle", name, new GetHandleOptions { Create = create });
        /// <summary>
        ...
        public Task<List<string>?> Resolve(FileSystemHandle possibleDescendant) => JSRef!.CallAsync<FileSystemHandle, List<string>?>("resolve", possibleDescendant);
        /// <summary>
