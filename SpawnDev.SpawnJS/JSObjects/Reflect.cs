namespace SpawnDev.SpawnJS.JSObjects
{
    ...
    public static class Reflect
    {
        ...
        public static bool DefineProperty(Union<SpawnJSObject, SpawnJSObjectReference> target, string propertyKey, object attributes) => JS.Call<bool>("Reflect.defineProperty", target, propertyKey, attributes);
        /// <summary>
        ...
        public static bool DeleteProperty(Union<SpawnJSObject, SpawnJSObjectReference> target, string propertyKey) => JS.Call<bool>("Reflect.deleteProperty", target, propertyKey);
        /// <summary>
        /// The Reflect.deleteProperty() static method is like the delete operator, but as a function. It deletes a property from an object.
        /// </summary>
        /// <param name="target">The target object on which to delete the property.</param>
        /// <param name="propertyKey">The name of the property to be deleted.</param>
        /// <returns>A boolean indicating whether or not the property was successfully deleted.</returns>
        public static bool DeleteProperty(Union<SpawnJSObject, SpawnJSObjectReference> target, int propertyKey) => JS.Call<bool>("Reflect.deleteProperty", target, propertyKey);
        /// <summary>
        ...
        public static T Get<T>(Union<SpawnJSObject, SpawnJSObjectReference> target, string propertyKey) => JS.Call<T>("Reflect.get", target, propertyKey);
        /// <summary>
        /// The Reflect.get() static method is like the property accessor syntax, but as a function.
        /// </summary>
        /// <typeparam name="T">Return type</typeparam>
        ...
        /// <returns>The value of the property.</returns>
        public static T Get<T>(Union<SpawnJSObject, SpawnJSObjectReference> target, int propertyKey, Union<SpawnJSObject, SpawnJSObjectReference> receiver) => JS.Call<T>("Reflect.get", target, propertyKey, receiver);
        /// <summary>
        /// The Reflect.get() static method is like the property accessor syntax, but as a function.
        /// </summary>
        /// <typeparam name="T">Return type</typeparam>
        ...
        /// <param name="propertyKey">The name of the property to get.</param>
        /// <returns>The value of the property.</returns>
        public static T Get<T>(Union<SpawnJSObject, SpawnJSObjectReference> target, int propertyKey) => JS.Call<T>("Reflect.get", target, propertyKey);
        /// <summary>
        /// The Reflect.get() static method is like the property accessor syntax, but as a function.
        /// </summary>
        /// <typeparam name="T">Return type</typeparam>
        ...
        /// <param name="receiver">The value of this provided for the call to target if a getter is encountered.</param>
        /// <returns>The value of the property.</returns>
        public static T Get<T>(Union<SpawnJSObject, SpawnJSObjectReference> target, string propertyKey, Union<SpawnJSObject, SpawnJSObjectReference> receiver) => JS.Call<T>("Reflect.get", target, propertyKey, receiver);
        /// <summary>
        ...
        public static PropertyDescriptor? GetOwnPropertyDescriptor(Union<SpawnJSObject, SpawnJSObjectReference> target, string propertyKey) => JS.Call<PropertyDescriptor?>("Reflect.getOwnPropertyDescriptor", target, propertyKey);
        /// <summary>
        ...
        public static SpawnJSObject? GetPrototypeOf(Union<SpawnJSObject, SpawnJSObjectReference> target) => JS.Call<SpawnJSObject?>("Reflect.getPrototypeOf", target);
        /// <summary>
        ...
        public static bool Has(Union<SpawnJSObject, SpawnJSObjectReference> target, string propertyKey) => JS.Call<bool>("Reflect.has", target, propertyKey);
        /// <summary>
        ...
        public static bool IsExtensible(Union<SpawnJSObject, SpawnJSObjectReference> target) => JS.Call<bool>("Reflect.isExtensible", target);
        /// <summary>
        ...
        /// </returns>
        public static Array OwnKeys(Union<SpawnJSObject, SpawnJSObjectReference> target) => JS.Call<Array>("Reflect.ownKeys", target);
        /// <summary>
        ...
        public static bool PreventExtensions(Union<SpawnJSObject, SpawnJSObjectReference> target) => JS.Call<bool>("Reflect.preventExtensions", target);
        /// <summary>
        ...
        public static bool Set(Union<SpawnJSObject, SpawnJSObjectReference> target, string propertyKey, object value) => JS.Call<bool>("Reflect.set", target, propertyKey, value);
        /// <summary>
        /// The Reflect.set() static method is like the property accessor and assignment syntax, but as a function.
        /// </summary>
        /// <param name="target">The target object on which to set the property.</param>
        ...
        /// <returns>A Boolean indicating whether or not setting the property was successful.</returns>
        public static bool Set(Union<SpawnJSObject, SpawnJSObjectReference> target, string propertyKey, object value, Union<SpawnJSObject, SpawnJSObjectReference> receiver) => JS.Call<bool>("Reflect.set", target, propertyKey, value, receiver);
        /// <summary>
        ...
        public static bool SetPrototypeOf(Union<SpawnJSObject, SpawnJSObjectReference> target, Union<SpawnJSObject, SpawnJSObjectReference> prototype) => JS.Call<bool>("Reflect.setPrototypeOf", target, prototype);
    }
}
