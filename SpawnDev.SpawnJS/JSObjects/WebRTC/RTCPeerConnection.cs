...
namespace SpawnDev.SpawnJS.JSObjects
{
    ...
    public class RTCPeerConnection : EventTarget
    {
        ...
        /// <returns></returns>
        public static RTCCertificate GenerateCertificate(RsaHashedKeyGenParams keygenAlgorithm) => JS.Call<RsaHashedKeyGenParams, RTCCertificate>("generateCertificate", keygenAlgorithm);
        /// <summary>
        /// Creates an X.509 certificate and its corresponding private key, returning a Promise that resolves with the new RTCCertificate once it is generated.
        /// </summary>
        /// <param name="keygenAlgorithm"></param>
        ...
        /// <param name="candidate"></param>
        /// <returns></returns>
        public Promise AddIceCandidatePromise(RTCIceCandidate candidate) => JSRef!.Call<RTCIceCandidate, Promise>("addIceCandidate", candidate);
        /// <summary>
        /// When a website or app using RTCPeerConnection receives a new ICE candidate from the remote peer over its signaling channel, it delivers the newly-received candidate to the browser's ICE agent by calling RTCPeerConnection.addIceCandidate(). This adds this new remote candidate to the RTCPeerConnection's remote description, which describes the state of the remote end of the connection.
        /// </summary>
        /// <param name="candidate"></param>
        ...
        /// <returns></returns>
        public Task<RTCSessionDescription> CreateAnswer(RTCAnswerOptions options) => JSRef!.CallAsync<RTCAnswerOptions, RTCSessionDescription>("createAnswer", options);
        /// <summary>
        ...
        /// <param name="options"></param>
        /// <returns></returns>
        public RTCDataChannel CreateDataChannel(string label, RTCDataChannelOptions? options = null) => JSRef!.Call<string, RTCDataChannelOptions, RTCDataChannel>("createDataChannel", label, options!);
        /// <summary>
        ...
        /// <param name="options"></param>
        /// <returns></returns>
        public Task<RTCSessionDescription> CreateOffer(RTCOfferOptions options) => JSRef!.CallAsync<RTCOfferOptions, RTCSessionDescription>("createOffer", options);
        /// <summary>
        ...
        /// <param name="desc"></param>
        /// <returns></returns>
        public Promise SetRemoteDescriptionPromise(RTCSessionDescription desc) => JSRef!.Call<RTCSessionDescription, Promise>("setRemoteDescription", desc);
        /// <summary>
        ...
        public RTCRtpSender AddTrack(MediaStreamTrack track) => JSRef!.Call<MediaStreamTrack, RTCRtpSender>("addTrack", track);
        /// <summary>
        /// The RTCPeerConnection method addTrack() adds a new media track to the set of tracks which will be transmitted to the other peer.
        /// </summary>
        ...
        /// <param name="trackOrKind"></param>
        /// <returns></returns>
        public RTCRtpTransceiver AddTransceiver(MediaStreamTrack trackOrKind) => JSRef!.Call<MediaStreamTrack, RTCRtpTransceiver>("addTransceiver", trackOrKind);
        /// <summary>
        /// The RTCPeerConnection method addTrack() adds a new media track to the set of tracks which will be transmitted to the other peer.
        /// </summary>
        /// <param name="trackOrKind"></param>
        ...
        /// <returns></returns>
        public RTCRtpTransceiver AddTransceiver(string trackOrKind, RTCRtpTransceiverOptions init) => JSRef!.Call<string, RTCRtpTransceiverOptions, RTCRtpTransceiver>("addTransceiver", trackOrKind, init);
        /// <summary>
        /// The RTCPeerConnection method addTrack() adds a new media track to the set of tracks which will be transmitted to the other peer.
        /// </summary>
        /// <param name="trackOrKind"></param>
        /// <param name="init"></param>
        /// <returns></returns>
        public RTCRtpTransceiver AddTransceiver(MediaStreamTrack trackOrKind, RTCRtpTransceiverOptions init) => JSRef!.Call<MediaStreamTrack, RTCRtpTransceiverOptions, RTCRtpTransceiver>("addTransceiver", trackOrKind, init);
        /// <summary>
        /// The RTCPeerConnection method addTrack() adds a new media track to the set of tracks which will be transmitted to the other peer.
        /// </summary>
        /// <param name="track">A MediaStreamTrack object representing the media track to add to the peer connection.</param>
        ...
        /// <returns></returns>
        public Task<RTCStatsReport> GetStats(MediaStreamTrack? selector = null) => JSRef!.CallAsync<MediaStreamTrack, RTCStatsReport>("getStats", selector!);
        /// <summary>
