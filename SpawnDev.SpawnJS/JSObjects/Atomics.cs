...
namespace SpawnDev.SpawnJS.JSObjects
{
    ...
    public static class Atomics
    {
        ...
        private static T _Add<[DynamicallyAccessedMembers(DynamicallyAccessedMemberTypes.PublicConstructors)] T>(TypedArray typedArray, long index, T value) => JS.Call<TypedArray, long, T, T>("Atomics.add", typedArray, index, value);
        /// <summary>
        ...
        private static T _And<[DynamicallyAccessedMembers(DynamicallyAccessedMemberTypes.PublicConstructors)] T>(TypedArray typedArray, long index, T value) => JS.Call<TypedArray, long, T, T>("Atomics.and", typedArray, index, value);
        /// <summary>
        ...
        private static T _CompareExchange<[DynamicallyAccessedMembers(DynamicallyAccessedMemberTypes.PublicConstructors)] T>(TypedArray typedArray, long index, T expectedValue, T replacementValue) => JS.Call<TypedArray, long, T, T, T>("Atomics.compareExchange", typedArray, index, expectedValue, replacementValue);
        /// <summary>
        ...
        private static T _Exchange<[DynamicallyAccessedMembers(DynamicallyAccessedMemberTypes.PublicConstructors)] T>(TypedArray typedArray, long index, T value) => JS.Call<TypedArray, long, T, T>("Atomics.exchange", typedArray, index, value);
        /// <summary>
        ...
        private static T _Load<[DynamicallyAccessedMembers(DynamicallyAccessedMemberTypes.PublicConstructors)] T>(TypedArray typedArray, long index) => JS.Call<TypedArray, long, T>("Atomics.load", typedArray, index);
        /// <summary>
        ...
        /// </returns>
        public static int Notify(TypedArray typedArray, long index, int count) => JS.Call<TypedArray, long, int, int>("Atomics.notify", typedArray, index, count);
        /// <summary>
        ...
        private static T _Or<[DynamicallyAccessedMembers(DynamicallyAccessedMemberTypes.PublicConstructors)] T>(TypedArray typedArray, long index, T value) => JS.Call<TypedArray, long, T, T>("Atomics.or", typedArray, index, value);
        /// <summary>
        ...
        private static T _Store<[DynamicallyAccessedMembers(DynamicallyAccessedMemberTypes.PublicConstructors)] T>(TypedArray typedArray, long index, T value) => JS.Call<TypedArray, long, T, T>("Atomics.store", typedArray, index, value);
        /// <summary>
        ...
        private static T _Sub<[DynamicallyAccessedMembers(DynamicallyAccessedMemberTypes.PublicConstructors)] T>(TypedArray typedArray, long index, T value) => JS.Call<TypedArray, long, T, T>("Atomics.sub", typedArray, index, value);
        /// <summary>
        ...
        private static string _Wait<T>(TypedArray typedArray, long index, T value) => JS.Call<TypedArray, long, T, string>("Atomics.wait", typedArray, index, value);
        /// <summary>
        /// The Atomics.wait() static method verifies that a shared memory location still contains a given value and if so sleeps, awaiting a wake-up notification or times out. It returns a string which is either "ok", "not-equal", or "timed-out".
        /// </summary>
        /// <typeparam name="T">TypedArray element .Net type</typeparam>
        ...
        private static string _Wait<T>(TypedArray typedArray, long index, T value, int timeout) => JS.Call<TypedArray, long, T, int, string>("Atomics.wait", typedArray, index, value, timeout);
        /// <summary>
        ...
        private static AtomicsWaitAsyncResult _WaitAsync<T>(TypedArray typedArray, long index, T value) => JS.Call<TypedArray, long, T, AtomicsWaitAsyncResult>("Atomics.waitAsync", typedArray, index, value);
        /// <summary>
        /// The Atomics.waitAsync() static method waits asynchronously on a shared memory location and returns a Promise.
        /// </summary>
        /// <typeparam name="T">TypedArray element .Net type</typeparam>
        ...
        private static AtomicsWaitAsyncResult _WaitAsync<T>(TypedArray typedArray, long index, T value, int timeout) => JS.Call<TypedArray, long, T, int, AtomicsWaitAsyncResult>("Atomics.waitAsync", typedArray, index, value, timeout);
        /// <summary>
        ...
        private static T _Xor<[DynamicallyAccessedMembers(DynamicallyAccessedMemberTypes.PublicConstructors)] T>(TypedArray typedArray, long index, T value) => JS.Call<TypedArray, long, T, T>("Atomics.xor", typedArray, index, value);
    }
}
