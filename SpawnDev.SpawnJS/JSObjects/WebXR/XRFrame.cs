...
namespace SpawnDev.SpawnJS.JSObjects
{
    ...
    public class XRFrame : SpawnJSObject
    {
        ...
        public Task<XRAnchor> CreateAnchor(XRRigidTransform pose, XRSpace space) => JSRef!.CallAsync<XRRigidTransform, XRSpace, XRAnchor>("createAnchor", pose, space);
        /// <summary>
        ...
        public bool FillJointRadii(IEnumerable<XRJointSpace> jointSpaces, Float32Array radii) => JSRef!.Call<global::System.Collections.Generic.IEnumerable<XRJointSpace>, Float32Array, bool>("fillJointRadii", jointSpaces, radii);
        /// <summary>
        ...
        /// <returns>A boolean indicating if all of the spaces have a valid pose.</returns>
        public bool FillPoses(IEnumerable<XRSpace> spaces, XRSpace baseSpace, Float32Array transforms) => JSRef!.Call<global::System.Collections.Generic.IEnumerable<XRSpace>, XRSpace, Float32Array, bool>("fillPoses", spaces, baseSpace, transforms);
        /// <summary>
        ...
        public XRCPUDepthInformation GetDepthInformation(XRView view) => JSRef!.Call<XRView, XRCPUDepthInformation>("getDepthInformation", view);
        /// <summary>
        ...
        /// <returns></returns>
        public XRHitTestResult[] GetHitTestResults(XRHitTestSource hitTestSource) => JSRef!.Call<XRHitTestSource, XRHitTestResult[]>("getHitTestResults", hitTestSource);
        /// <summary>
        ...
        /// <returns></returns>
        public XRJointPose GetJointPose(XRJointSpace joint, XRSpace baseSpace) => JSRef!.Call<XRJointSpace, XRSpace, XRJointPose>("getJointPose", joint, baseSpace);
        /// <summary>
        ...
        /// <returns></returns>
        public XRLightEstimate? GetLightEstimate(XRLightProbe lightProbe) => JSRef!.Call<XRLightProbe, XRLightEstimate?>("getLightEstimate", lightProbe);
        /// <summary>
        ...
        /// <param name="baseSpace"></param>
        /// <returns></returns>
        public XRPose GetPose(XRSpace space, XRSpace baseSpace) => JSRef!.Call<XRSpace, XRSpace, XRPose>("getPose", space, baseSpace);
        /// <summary>
        ...
        /// <returns></returns>
        public XRViewerPose GetViewerPose(XRReferenceSpace referenceSpace) => JSRef!.Call<XRReferenceSpace, XRViewerPose>("getViewerPose", referenceSpace);
        /// <summary>
        ...
        /// <returns></returns>
        public XRTransientInputHitTestResult[] GetHitTestResultsForTransientInput(XRTransientInputHitTestSource hitTestSource) => JSRef!.Call<XRTransientInputHitTestSource, XRTransientInputHitTestResult[]>("getHitTestResultsForTransientInput", hitTestSource);
        /// <summary>
