...
namespace SpawnDev.SpawnJS.JSObjects
{
    ...
    public class XRReferenceSpace : XRSpace
    {
        ...
        public XRReferenceSpace GetOffsetReferenceSpace(XRRigidTransform originOffset) => JSRef!.Call<XRRigidTransform, XRReferenceSpace>("getOffsetReferenceSpace", originOffset);
        /// <summary>
