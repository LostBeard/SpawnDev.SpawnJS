...
namespace SpawnDev.SpawnJS.JSObjects
{
    ...
    public class XRSession : EventTarget
    {
        ...
        /// <returns></returns>
        public long RequestAnimationFrame(Action<double, XRFrame?> callback) => JSRef!.Call<global::SpawnDev.SpawnJS.ActionCallback<double, XRFrame>, long>("requestAnimationFrame", Callback.CreateOne(callback)!);
        /// <summary>
        /// Schedules the specified method to be called the next time the user agent is working on rendering an animation frame for the WebXR device. Returns an integer value which can be used to identify the request for the purposes of canceling the callback using cancelAnimationFrame(). This method is comparable to the Window.requestAnimationFrame() method.
        /// </summary>
        /// <param name="callback"></param>
        /// <returns></returns>
        public long RequestAnimationFrame(ActionCallback<double, XRFrame?> callback) => JSRef!.Call<global::SpawnDev.SpawnJS.ActionCallback<double, XRFrame>, long>("requestAnimationFrame", callback!);
        /// <summary>
        /// Requests an XRHitTestSource object that handles hit test subscription.
        /// </summary>
        /// <param name="options"></param>
        /// <returns></returns>
        public Task<XRHitTestSource> RequestHitTestSource(XRHitTestOptionsInit options) => JSRef!.CallAsync<XRHitTestOptionsInit, XRHitTestSource>("requestHitTestSource", options);
        /// <summary>
        ...
        /// <param name="options"></param>
        /// <returns></returns>
        public Task<XRTransientInputHitTestSource> RequestHitTestSourceForTransientInput(XRTransientInputHitTestOptionsInit options) => JSRef!.CallAsync<XRTransientInputHitTestOptionsInit, XRTransientInputHitTestSource>("requestHitTestSourceForTransientInput", options);
        /// <summary>
        ...
        public Task<XRLightProbe> RequestLightProbe(XRLightProbeInit? options = null)
            => options == null ? JSRef!.CallAsync<XRLightProbe>("requestLightProbe") : JSRef!.CallAsync<XRLightProbeInit, XRLightProbe>("requestLightProbe", options);
        /// <summary>
        ...
        /// <returns></returns>
        public Task<XRReferenceSpace> RequestReferenceSpace(EnumString<XRReferenceSpaceType> type) => JSRef!.CallAsync<global::SpawnDev.SpawnJS.EnumString<XRReferenceSpaceType>, XRReferenceSpace>("requestReferenceSpace", type);
        /// <summary>
