...
namespace SpawnDev.SpawnJS.JSObjects
{
    ...
    public class XRWebGLBinding : SpawnJSObject
    {
        ...
        /// </summary>
        /// <returns></returns>
        public XRCubeLayer CreateCubeLayer(XRCubeLayerInit options) => JSRef!.Call<XRCubeLayerInit, XRCubeLayer>("createCubeLayer", options);
        /// <summary>
        ...
        /// <returns></returns>
        public XRCylinderLayer CreateCylinderLayer(XRCylinderLayerInit options) => JSRef!.Call<XRCylinderLayerInit, XRCylinderLayer>("createCylinderLayer", options);
        /// <summary>
        ...
        /// <param name="options"></param>
        /// <returns></returns>
        public XRProjectionLayer CreateProjectionLayer(XRProjectionLayerInit options) => JSRef!.Call<XRProjectionLayerInit, XRProjectionLayer>("createProjectionLayer", options);
        /// <summary>
        ...
        /// <param name="options"></param>
        /// <returns></returns>
        public XRQuadLayer CreateQuadLayer(XRQuadLayerInit options) => JSRef!.Call<XRQuadLayerInit, XRQuadLayer>("createQuadLayer", options);
        /// <summary>
        ...
        /// <param name="options"></param>
        /// <returns></returns>
        public XREquirectLayer CreateEquirectLayer(XREquirectLayerInit options) => JSRef!.Call<XREquirectLayerInit, XREquirectLayer>("createEquirectLayer", options);
        /// <summary>
        /// Returns an XRWebGLDepthInformation object containing WebGL depth information.
        /// </summary>
        /// <returns></returns>
        public XRWebGLDepthInformation GetDepthInformation(XRView view) => JSRef!.Call<XRView, XRWebGLDepthInformation>("getDepthInformation", view);
        /// <summary>
        ...
        /// <returns></returns>
        public WebGLTexture GetReflectionCubeMap(XRLightProbe lightProbe) => JSRef!.Call<XRLightProbe, WebGLTexture>("getReflectionCubeMap", lightProbe);
        /// <summary>
        ...
        public XRWebGLSubImage GetSubImage(XRCompositionLayer layer, XRFrame frame, string eye) => JSRef!.Call<XRCompositionLayer, XRFrame, string, XRWebGLSubImage>("getSubImage", layer, frame, eye);
        /// <summary>
        /// The getSubImage() method of the XRWebGLBinding interface returns a XRWebGLSubImage object representing the WebGL texture to render.
        /// </summary>
        /// <param name="layer">The XRCompositionLayer to use for rendering (can be all types of XRCompositionLayer objects except XRProjectionLayer, see XRWebGLBinding.getViewSubImage() for rendering projection layers).</param>
        /// <param name="frame">The XRFrame frame to use for rendering.</param>
        /// <returns>A XRWebGLSubImage object.</returns>
        public XRWebGLSubImage GetSubImage(XRCompositionLayer layer, XRFrame frame) => JSRef!.Call<XRCompositionLayer, XRFrame, XRWebGLSubImage>("getSubImage", layer, frame);
        /// <summary>
        ...
        /// <returns>A XRWebGLSubImage object.</returns>
        public XRWebGLSubImage GetViewSubImage(XRProjectionLayer layer, XRView view) => JSRef!.Call<XRProjectionLayer, XRView, XRWebGLSubImage>("getViewSubImage", layer, view);
    }
}
