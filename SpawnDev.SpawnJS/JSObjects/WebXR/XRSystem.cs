...
namespace SpawnDev.SpawnJS.JSObjects
{
    ...
    public class XRSystem : EventTarget
    {
        ...
        /// <returns></returns>
        public Task<bool> IsSessionSupported(EnumString<XRSessionMode> mode) => JSRef!.CallAsync<global::SpawnDev.SpawnJS.EnumString<XRSessionMode>, bool>("isSessionSupported", mode);
        /// <summary>
        ...
        public Task<XRSession> RequestSession(EnumString<XRSessionMode> mode, XRSessionInit? options = null)
            => options == null ? JSRef!.CallAsync<global::SpawnDev.SpawnJS.EnumString<XRSessionMode>, XRSession>("requestSession", mode) : JSRef!.CallAsync<global::SpawnDev.SpawnJS.EnumString<XRSessionMode>, XRSessionInit, XRSession>("requestSession", mode, options);
        /// <summary>
