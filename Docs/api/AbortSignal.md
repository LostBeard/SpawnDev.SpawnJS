...
|---|---|
| `AbortSignal(SpawnJSObjectReference _ref)` | Deserialization constructor |
...
| `Reason` | `SpawnJSObject?` | get | A JavaScript value providing the abort reason, once the signal has aborted. |
