...
**Namespace:** `SpawnDev.SpawnJS.JSObjects.Bluetooth`  
**Inheritance:** `SpawnJSObject` -> `EventTarget` -> `Bluetooth`  
...
|---|---|
| `Bluetooth(SpawnJSObjectReference _ref)` | Deserialization constructor. Access via `navigator.Bluetooth`. |
