...
**Inheritance:** SpawnJSRuntime  
**Source:** `SpawnDev.SpawnJS/SpawnJSRuntime.cs`, `SpawnDev.SpawnJS/SpawnJSRuntimeExt.cs`
...
await builder.Build().SpawnJSRunAsync(); // NOT RunAsync()
```
...
// Via static property on SpawnJSObject
SpawnJSRuntime js = SpawnJSObject.JS;

// Via static property on SpawnJSRuntime itself
...
|---|---|---|
| `JS` | `SpawnJSRuntime` | Static singleton instance. Accessible from anywhere. |
| `GlobalThis` | `SpawnJSObject?` | The globalThis SpawnJSObject instance for the current scope. |
...
| `InformationalVersion` | `string` | The SpawnJSRuntime assembly informational version. |
| `FileVersion` | `string` | The SpawnJSRuntime assembly file version. |
...
| Method | Return Type | Description |
|---|---|---|
| `New(string className, ...)` | `SpawnJSObjectReference` | Create a new JS object (0-10 args). Returns raw reference. |
| `New<T>(string className, ...)` | `T` | Create a new JS object and return as typed wrapper (0-10 args). |
| `NewApply(string className, object?[]? args)` | `SpawnJSObjectReference` | Create a new JS object with args array. |
...
| `ToJSRef(ElementReference elementRef)` | `SpawnJSObjectReference` | Convert a Blazor ElementReference to a JSRef. |
