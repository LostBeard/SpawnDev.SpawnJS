...
**MDN Reference:** [ResponseOptions on MDN](https://developer.mozilla.org/en-US/docs/Web/API/Response/Response#options)
...
*[See full example on MDN](https://developer.mozilla.org/en-US/docs/Web/API/Response/Response)*
