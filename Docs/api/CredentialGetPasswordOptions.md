# CredentialGetPasswordOptions

**Namespace:** `SpawnDev.SpawnJS.JSObjects`  
**Inherits:** `CredentialGetOptions`  
**Source:** `JSObjects/CredentialGetPasswordOptions.cs`  
**MDN Reference:** [CredentialGetPasswordOptions on MDN](https://developer.mozilla.org/en-US/docs/Web/API/CredentialsContainer/get#options)

> If used for CredentialsContainer.Get() a PasswordCredential will be returned https://developer.mozilla.org/en-US/docs/Web/API/CredentialsContainer/get#options

## Properties

| Property | Type | Access | Description |
|---|---|---|---|
| `Password` | `bool` | get | A boolean value indicating that a password credential is being requested. See the Credential Management API section below for more details. |
...
> - Access via `JS.Get<CredentialGetPasswordOptions>(...)` or constructor `new CredentialGetPasswordOptions(...)`
