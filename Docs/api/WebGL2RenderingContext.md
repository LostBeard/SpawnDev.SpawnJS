...
**Inheritance:** `SpawnJSObject` -> `WebGLRenderingContextBase` -> `WebGL2RenderingContextBase` -> `WebGL2RenderingContext`  
...
|-----------|-------------|
| `WebGL2RenderingContext(SpawnJSObjectReference _ref)` | Deserialization constructor. |
