...
**Inheritance:** SpawnJSObject -> EventTarget -> Node -> Element -> HTMLElement  
**MDN Reference:** [HTMLElement on MDN](https://developer.mozilla.org/en-US/docs/Web/API/HTMLElement)  
**Source:** `SpawnDev.SpawnJS/JSObjects/DOM/HTMLElement.cs`
...
```csharp
public HTMLElement(SpawnJSObjectReference _ref)
