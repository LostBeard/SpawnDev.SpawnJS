# CredentialCreatePublicKeyExclude

**Namespace:** `SpawnDev.SpawnJS.JSObjects`  
**Source:** `JSObjects/CredentialCreatePublicKeyExclude.cs`  
**MDN Reference:** [CredentialCreatePublicKeyExclude on MDN](https://developer.mozilla.org/en-US/docs/Web/API/CredentialsContainer/create#excludecredentials)

> Options for CredentialCreatePublicKey.ExcludeCredentials https://developer.mozilla.org/en-US/docs/Web/API/CredentialsContainer/create#excludecredentials

## Properties

| Property | Type | Access | Description |
|---|---|---|---|
| `CredentialCreatePublicKeyExclude` | `class` | get | Options for CredentialCreatePublicKey.ExcludeCredentials https://developer.mozilla.org/en-US/docs/Web/API/CredentialsContainer/create#excludecredentials |
| `Transports` | `List<string>?` | get |  |
| `Type` | `string` | get | A string defining the type of public key credential to create. This can currently take a single value, "public-key", but more values may be added in the future. |
...
> - Access via `JS.Get<CredentialCreatePublicKeyExclude>(...)` or constructor `new CredentialCreatePublicKeyExclude(...)`
