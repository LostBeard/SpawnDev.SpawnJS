...
|---|---|
| `FileReader(SpawnJSObjectReference _ref)` | Deserialization constructor |
...
|---|---|---|---|
| `Result` | `SpawnJSObject?` | get | The file's contents. This property is only valid after the read operation is complete, and the format of the data depends on which of the methods was used to initiate the read operation. |
