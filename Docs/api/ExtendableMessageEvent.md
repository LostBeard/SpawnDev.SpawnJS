...
|---|---|
| `ExtendableMessageEvent(SpawnJSObjectReference _ref)` | Deserialization constructor |

## Properties

| Property | Type | Access | Description |
|---|---|---|---|
| `Data` | `SpawnJSObject?` | get | Returns the data as a SpawnJSObject, whcih can represent any data type. |
