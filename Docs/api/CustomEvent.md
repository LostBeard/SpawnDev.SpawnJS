...
**Inheritance:** SpawnJSObject -> Event -> CustomEvent  
**MDN Reference:** [CustomEvent on MDN](https://developer.mozilla.org/en-US/docs/Web/API/CustomEvent)  
**Source:** `SpawnDev.SpawnJS/JSObjects/DOM/CustomEvent.cs`
...
public CustomEvent(SpawnJSObjectReference _ref)
```
...
|---|---|---|
| `Detail` | `SpawnJSObject?` | The custom data passed when the event was created. Returns as SpawnJSObject. |
