...
**Source:** `JSObjects/CredentialGetOtp.cs`  
**MDN Reference:** [CredentialGetOtp on MDN](https://developer.mozilla.org/en-US/docs/Web/API/CredentialsContainer/get#otp_object_structure)

> Options for CredentialsContainer.Get() CredentialsContainer.Get() will return a Promise that resolves with an OTPCredential object instance. https://developer.mozilla.org/en-US/docs/Web/API/CredentialsContainer/get#otp_object_structure

## Properties

| Property | Type | Access | Description |
|---|---|---|---|
| `CredentialGetOtp` | `class` | get | Options for CredentialsContainer.Get() CredentialsContainer.Get() will return a Promise that resolves with an OTPCredential object instance. https://developer.mozilla.org/en-US/docs/Web/API/CredentialsContainer/get#otp_object_structure |
...
> - Access via `JS.Get<CredentialGetOtp>(...)` or constructor `new CredentialGetOtp(...)`
