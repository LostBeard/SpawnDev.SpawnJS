...
**Namespace:** `SpawnDev.SpawnJS.JSObjects.USB`  
**Inheritance:** `SpawnJSObject` -> `EventTarget` -> `USB`  
...
|---|---|
| `USB(SpawnJSObjectReference _ref)` | Deserialization constructor. Access via `navigator.Usb`. |
