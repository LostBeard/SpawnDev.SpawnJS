# CredentialGetFederated

**Namespace:** `SpawnDev.SpawnJS.JSObjects`  
**Source:** `JSObjects/CredentialGetFederated.cs`  
**MDN Reference:** [CredentialGetFederated on MDN](https://developer.mozilla.org/en-US/docs/Web/API/CredentialsContainer/get#federated_object_structure)

> Used with CredentialGetPublicKeyOptions https://developer.mozilla.org/en-US/docs/Web/API/CredentialsContainer/get#federated_object_structure

## Properties

| Property | Type | Access | Description |
|---|---|---|---|
| `CredentialGetFederated` | `class` | get | Used with CredentialGetPublicKeyOptions https://developer.mozilla.org/en-US/docs/Web/API/CredentialsContainer/get#federated_object_structure |
| `Providers` | `IEnumerable<string>` | get | An array of strings representing the credentials' federated identity providers (for example "https://www.facebook.com" or "https://accounts.google.com"). |
...
> - Access via `JS.Get<CredentialGetFederated>(...)` or constructor `new CredentialGetFederated(...)`
