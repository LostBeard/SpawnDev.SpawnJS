...
**Inheritance:** SpawnJSObject -> EventTarget -> Node -> DocumentFragment -> ShadowRoot  
**MDN Reference:** [ShadowRoot on MDN](https://developer.mozilla.org/en-US/docs/Web/API/ShadowRoot)  
**Source:** `SpawnDev.SpawnJS/JSObjects/DOM/ShadowRoot.cs`
...
```csharp
public ShadowRoot(SpawnJSObjectReference _ref)
```
