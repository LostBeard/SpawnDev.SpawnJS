...
**Inheritance:** `SpawnJSObject` -> `EventTarget` -> `OffscreenCanvas`  
...
| `OffscreenCanvas(SpawnJSObjectReference _ref)` | Deserialization constructor - wraps an existing JS object reference. |
