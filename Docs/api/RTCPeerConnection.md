...
**Namespace:** `SpawnDev.SpawnJS.JSObjects.WebRTC`  
**Inheritance:** `SpawnJSObject` -> `EventTarget` -> `RTCPeerConnection`  
...
| `RTCPeerConnection(SpawnJSObjectReference _ref)` | Deserialization constructor. |
