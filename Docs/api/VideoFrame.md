...
**Inheritance:** `SpawnJSObject` -> `VideoFrame`  
...
|---|---|
| `VideoFrame(SpawnJSObjectReference _ref)` | Deserialization constructor. |
...
| `ColorSpace` | `SpawnJSObject` | The color space of the frame. |
