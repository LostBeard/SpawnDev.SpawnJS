...
| Method | Return Type | Description |
|---|---|---|
| `GetPrototypeOf(target)` | `SpawnJSObject?` | Returns the prototype of the target object, or `null`. |
...
```csharp
using var obj = JS.Call<SpawnJSObject>("Object.create", null);
...
using var keyed = JS.Call<SpawnJSObject>("Object.create", null);
...
using var date = Reflect.Construct<SpawnJSObject>(dateCtor, new object[] { });
```
