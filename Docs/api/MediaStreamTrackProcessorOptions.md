...
**MDN Reference:** [MediaStreamTrackProcessorOptions on MDN](https://developer.mozilla.org/en-US/docs/Web/API/MediaStreamTrackProcessor/MediaStreamTrackProcessor#options)
...
*[See full example on MDN](https://developer.mozilla.org/en-US/docs/Web/API/MediaStreamTrackProcessor/MediaStreamTrackProcessor)*
