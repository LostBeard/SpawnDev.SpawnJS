...
**Inheritance:** SpawnJSObject -> EventTarget -> Node -> Element -> HTMLElement -> HTMLMediaElement -> HTMLVideoElement  
**MDN Reference:** [HTMLVideoElement on MDN](https://developer.mozilla.org/en-US/docs/Web/API/HTMLVideoElement)  
**Source:** `SpawnDev.SpawnJS/JSObjects/DOM/HTMLVideoElement.cs`
...
```csharp
public HTMLVideoElement(SpawnJSObjectReference _ref)
```
...
## Example - From SpawnDev.SpawnJS README
