...
**Source:** `JSObjects/CredentialGetOptions.cs`  
**MDN Reference:** [CredentialGetOptions on MDN](https://developer.mozilla.org/en-US/docs/Web/API/CredentialsContainer/get#options)

> Options used for CredentialsContainer.Get() https://developer.mozilla.org/en-US/docs/Web/API/CredentialsContainer/get#options

## Properties

| Property | Type | Access | Description |
|---|---|---|---|
| `CredentialGetOptions` | `abstract class` | get | Options used for CredentialsContainer.Get() https://developer.mozilla.org/en-US/docs/Web/API/CredentialsContainer/get#options |
| `Mediation` | `string?` | get |  |
...
> - Access via `JS.Get<CredentialGetOptions>(...)` or constructor `new CredentialGetOptions(...)`
