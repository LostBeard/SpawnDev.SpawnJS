...
|---|---|
| `CustomQueuingStrategy(int highWaterMark, Func<SpawnJSObject, int> size)` | The ByteLengthQueuingStrategy() constructor creates and returns a ByteLengthQueuingStrategy object instance. |
