...
**Inheritance:** `SpawnJSObject` -> `CryptoKeyBase` -> `CryptoKey`  
...
|---|---|
| `CryptoKey(SpawnJSObjectReference _ref)` | Deserialization constructor. Not directly instantiated - obtained from `SubtleCrypto` methods. |
