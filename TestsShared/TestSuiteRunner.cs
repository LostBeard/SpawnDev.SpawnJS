...
namespace TestsShared
{
    ...
    public static class TestSuiteRunner
    {
        ...
        /// </summary>
        public static Type[] TestTypes { get; } = new[] { typeof(JSInteropTestsCore), typeof(JSToNetTests), typeof(PortedJSObjectTests), typeof(EventTests), typeof(UnionTests), typeof(CallbackSharingTests) };
        /// <summary>
